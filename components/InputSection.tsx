        ...
        <div>
          ...
          {file ? (
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 rounded-md bg-slate-700/50 px-3 py-2.5 text-sm font-semibold text-slate-300 ring-1 ring-inset ring-slate-700 hover:bg-slate-700 transition-colors duration-200 disabled:opacity-50 h-[46px]"
            >
